package com.isi.master.gl.config;
...
import com.isi.master.gl.security.SecurityUtils;
import com.isi.master.gl.security.oauth2.AudienceValidator;
import com.isi.master.gl.security.oauth2.JwtGrantedAuthorityConverter;
        ...
        http
            ...
            .authorizeExchange(
                ...
                authz
                    ...
                    .pathMatchers(" r").hasAuthority(AuthoritiesConstants.ADMIN)
